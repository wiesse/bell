...
//var periodsE = [8*60, 8*60+10, 8*60+10, 9*60, 9*60+5, 10*60, 10*60+5, 11*60, 11*60+5, 12*60+04, 12*60+04, 12*60+04, 12*60+04, 12*60+04, 12*60+04, 12*60+04];

var all_periods = [periodsA, periodsB, periodsC, periodsD];//, periodsE]
...
var schedules = ["scheduleA", "scheduleB", "scheduleC", "scheduleD"];//, "scheduleE"];
...
//var classesE = ["adv1E", "adv2E", "S1E", "S2E", "S3E", "void1", "void2", "void3"];

var all_classes = [classesA, classesB, classesC, classesD];//, classesE];
